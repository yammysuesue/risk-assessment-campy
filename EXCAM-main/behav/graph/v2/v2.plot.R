...
ggsave("activity_keys_age1.tiff", plot = g1,
       units="in", width=5, height=4, dpi=300, compression = 'lzw')
ggsave("activity_keys_age2.tiff", plot = g1,
       units="in", width=5, height=4, dpi=300, compression = 'lzw')
...
g2 <- ggplot(time.dat.com, aes(time, id)) + 
  ...
  theme(axis.text.y = element_text(size = 4)) + scale_y_discrete(labels = my_label$label)
g2
ggsave("compartment_keys_age1.tiff", plot = g2,
       units="in", width=5, height=4, dpi=300, compression = 'lzw')
ggsave("compartment_keys_age2.tiff", plot = g2,
       units="in", width=5, height=4, dpi=300, compression = 'lzw')
